...
이 저장소는 **development-rules**, **dev-kit**과 함께 운영됩니다.
...
│                                                                 │
│  5️⃣ 완료                                                        │
│     └── development-rules/case-studies에 상세 기록              │
│         - "왜" 이렇게 했는지 기록                                │
│         상태: ✅ completed                                       │
│                                                                 │
│  6️⃣ 다음 세션                                                   │
...
| **development-rules** | 개발 규칙/케이스스터디 | `redjokerv1-cmd/development-rules` |
